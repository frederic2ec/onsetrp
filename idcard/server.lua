...
AddRemoteEvent("ShowIdCard", function(player)
    ...
    if(nearestPlayer ~= nil) then
	    CallRemoteEvent(nearestPlayer[1], "OnCardDataLoaded",  PlayerData[player].accountid, PlayerData[player].name, PlayerData[player].driver_license == 1, PlayerData[player].gun_license == 1, PlayerData[player].helicopter_license == 1, PlayerData[player].age)
	else
