...
AddCommand("polcuff", function(player, target)
    SetPlayerCuffed(tonumber(target), true)
end)

AddCommand("poluncuff", function(player, target)
    SetPlayerCuffed(tonumber(target), false)
end)

AddCommand("polfine", function(agentId, playerId, amount, reason)
    AddFineInDb(agentId, tonumber(playerId), amount, reason)
end)

AddCommand("polincar", function(player, target)
    SetPlayerInCar(player, tonumber(target))
end)

AddCommand("poloutcar", function(player)
    RemovePlayerInCar(player)
end)

AddCommand("polfrisk", function(player, target)
    LaunchFriskPlayer(player, target)
end)
