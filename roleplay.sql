...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  `keep_on_death` tinyint(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
...
INSERT INTO `items` (`id`, `name`, `category`, `subcategory`, `price`, `weight`, `hunger`, `thirst`, `equipable`, `usable`, `keep_on_death`) VALUES
	(NULL, 'water_bottle', 'miscellaneous', 'food', 10, 2000, 0, 30, 0, 1, 0),
	(NULL, 'apple', 'miscellaneous', 'food', 25, 2000, 30, 0, 0, 1, 0),
	(NULL, 'donut', 'miscellaneous', 'food', 30, 2000, 30, 0, 0, 1, 0),
	(NULL, 'repair_kit', 'ironsmith', 'object', 300, 6000, 0, 0, 0, 1, 0),
	(NULL, 'health_kit', 'miscellaneous', 'object', 150, 5000, 0, 0, 0, 1, 0),
	(NULL, 'lockpick', 'ironsmith', 'object', 500, 4000, 0, 0, 0, 1, 0),
	(NULL, 'pickaxe', 'ironsmith', 'tool', 60, 3000, 0, 0, 0, 1, 0),
	(NULL, 'jerican', 'miscellaneous', 'object', 200, 8000, 0, 0, 0, 1, 0),
	(NULL, 'phone', 'miscellaneous', 'object', 150, 2000, 0, 0, 0, 1, 1),
	(NULL, 'fishing_rod', 'ironsmith', 'tool', 60, 3000, 0, 0, 0, 1, 0),
	(NULL, 'weapon_2', 'weapons', 'weapon', 39000, 7000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_3', 'weapons', 'weapon', 45000, 6000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_4', 'weapons', 'weapon', 48000, 5000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_5', 'weapons', 'weapon', 43000, 6000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_6', 'weapons', 'weapon', 65000, 17000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_7', 'weapons', 'weapon', 66000, 17000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_8', 'weapons', 'weapon', 80000, 13000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_9', 'weapons', 'weapon', 80000, 12000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_10', 'weapons', 'weapon', 80000, 14000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_11', 'weapons', 'weapon', 185000, 16000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_12', 'weapons', 'weapon', 170000, 18000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_13', 'weapons', 'weapon', 5000000, 18000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_14', 'weapons', 'weapon', 210000, 20000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_15', 'weapons', 'weapon', 110000, 20000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_16', 'weapons', 'weapon', 180000, 18000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_17', 'weapons', 'weapon', 190000, 20000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_18', 'weapons', 'weapon', 135000, 20000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_19', 'weapons', 'weapon', 200000, 20000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_20', 'weapons', 'weapon', 5000000, 30000, 0, 0, 1, 0, 0),
	(NULL, 'weapon_21', 'weapons', 'weapon', 5000000, 5000, 0, 0, 1, 0, 0),
	(NULL, 'iron_pipe', 'job_item', 'object', 0, 16000, 0, 0, 0, 0, 0),
	(NULL, 'peach', 'job_item', 'food', 0, 4000, 30, 5, 0, 1, 0),
	(NULL, 'item_backpack', 'miscellaneous', 'object', 150, 1000, 0, 0, 1, 0, 1),
	(NULL, 'coca_leaf', 'drugs', 'object', 0, 1000, 0, 0, 0, 0, 0),
	(NULL, 'cocaine', 'drugs', 'object', 0, 4000, 0, 0, 0, 1, 0),
	(NULL, 'lumberjack_axe', 'ironsmith', 'tool', 60, 3000, 0, 0, 0, 0, 0),
	(NULL, 'tree_log', 'job_item', 'object', 0, 12000, 0, 0, 0, 0, 0),
	(NULL, 'wood_plank', 'job_item', 'object', 0, 6000, 0, 0, 0, 0, 0),
	(NULL, 'iron_ingot', 'job_item', 'object', 0, 8000, 0, 0, 0, 0, 0),
	(NULL, 'lumberjack_saw', 'ironsmith', 'tool', 60, 3000, 0, 0, 0, 0, 0),
	(NULL, 'handcuffs', 'job_item', 'tool', 0, 1000, 0, 0, 0, 0, 0),
	(NULL, 'iron_ore', 'job_item', 'object', 0, 16000, 0, 0, 0, 0, 0),
	(NULL, 'defibrillator', 'job_item', 'tool', 0, 6000, 0, 0, 0, 0, 0),
	(NULL, 'adrenaline_syringe', 'job_item', 'tool', 0, 1000, 0, 0, 0, 1, 0),
	(NULL, 'bandage', 'job_item', 'tool', 0, 1000, 0, 0, 0, 1, 0),
	(NULL, 'herring', 'job_item', 'food', 0, 5000, 35, 0, 0, 1, 0),
	(NULL, 'mask_1', 'masks', 'object', 5000, 100, 0, 0, 1, 0, 0),
	(NULL, 'mask_2', 'masks', 'object', 6000, 100, 0, 0, 1, 0, 0),
	(NULL, 'mask_3', 'masks', 'object', 8000, 100, 0, 0, 1, 0, 0),
	(NULL, 'mask_4', 'masks', 'object', 10000, 100, 0, 0, 1, 0, 0);
